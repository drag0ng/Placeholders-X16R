/* src/config/placeh-config.h.  Generated from placeh-config.h.in by configure.  */
/* src/config/placeh-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PLACEH_CONFIG_H

#define PLACEH_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Placeholder Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Placeholder Core"
...
#define PACKAGE_BUGREPORT "https://github.com/PlacehProject/Placeholders/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Placeholder Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Placeholder Core 2.1.3"
